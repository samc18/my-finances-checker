function Fundamentals() {
  return (
    <main className="fundamentals">
      <div className="fundamentals__title">
        <h1>The 50/30/20 rule explained!</h1>
        <p className="fundamentals__description">
          A popular budgeting method that distributes income into 3 main
          categories.
        </p>
      </div>
      ...
      <div className="fundamentals__container main">
        ...
        <p className="fundamentals__description">
          This amount is your monthly income after taxes. There can be more than
          one. If it's the salary from work just remove the taxes not other
          amounts that are usually deducted.
        </p>
      </div>
      ...
      <div className="grid">
        <div className="fundamentals__container">
          ...
          <p className="fundamentals__description">
            Necessities are the expenses we can not live without. Here are some
            examples:
          </p>
          <ul className="fundamentals__list">
            ...
            <li className="fundamentals__item">
              Minimum loan payments. Anything beyond the minimum goes into
              savings.
            </li>
            <li className="fundamentals__item">
              Expenses you need to cover so you can work, child care for
              example.
            </li>
          </ul>
        </div>
        ...
        <div className="fundamentals__container">
          ...
          <p className="fundamentals__description">
            Wants are the extras we do for fun. They are not essential as in we
            can live without them. Here are some examples:
          </p>
          <ul className="fundamentals__list">
        ...
        <div className="fundamentals__container">
          <h2 className="fundamentals__subtitle">
            20% of your income: savings.
          </h2>
          <i className="fa-solid fa-piggy-bank"></i>
          <p className="fundamentals__description">
            Savings is the category we set aside to prepare for the future. We
            start by repaying debt. High-interest accounts should be targeted
